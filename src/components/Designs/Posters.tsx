    ...
    return (
        <>
            ...
            <div className='w-fit lg:w-[80%] grid grid-cols-2 gap-5 md:gap-10 mb-10'>
                <img className='rounded-xl' src={Spiderman} alt={Spiderman} />
                <img className='rounded-xl' src={Jumanji} alt={Jumanji} />
                <img className='rounded-xl' src={Aaryan} alt={Aaryan} />
                <img className='rounded-xl' src={Jaden} alt={Spiderman} />
            </div>
        </>
    )
}
