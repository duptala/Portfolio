    ...
    return (
        <>
            ...
            <p className="text-xs md:text-xs text-center text-gray-500 dark:text-gray-300 max-w-4xl mb-3">
                {" "}
                I've designed YouTube banners for many clients, including popular creators like Lachlan, TekkerzKid, Morgz, and Jeanfils, all with over <span className='text-pink-400 font-bold dark:text-yellow-200'>1 million subscribers!</span> For more of my work, check out my Behance portfolio!
            </p>
            <div className="flex flex-row gap-2 w-44 sm:w-52 justify-center items-center mb-4">
                <a href="https://www.youtube.com/@lachlan" target="_blank" rel="noopener noreferrer">
                    <img src={LachlanIcon} alt="Lachlan Icon" />
                </a>
                <a href="https://www.youtube.com/@Morgz" target="_blank" rel="noopener noreferrer">
                    <img src={MorgzIcon} alt="Morgz Icon" />
                </a>
                <a href="https://www.youtube.com/@Jeanfils" target="_blank" rel="noopener noreferrer">
                    <img src={JeanfilsIcon} alt="Jeanfils Icon" />
                </a>
                <a href="https://www.youtube.com/@TekkerzkidOfficial" target="_blank" rel="noopener noreferrer">
