...
const experiences: IExperience[] = [
    {
        ...
        present: true,
        responsibilities: `
        • Currently collaborating in a team of 9 to develop a website for AUIS, designed to serve over 500 university students.
    ...
    },
    {
        ...
        present: true,
        responsibilities: `
        • Designed visual content to promote and encourage participation in club events, including social media posts and event posters.
    ...
    },
    {
        ...
        end_date: "FEB 2024",
        responsibilities: `
        •Led projects focusing on web scraping, computer vision, and Azure Cloud Services to improve data extraction, infrastructure analysis, and operational efficiency
