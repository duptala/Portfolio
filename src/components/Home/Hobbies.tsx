        ...
        <div className="w-full h-full flex flex-col bg-hobbies rounded-3xl p-3">
            ...
            <ul className="text-center h-full flex flex-col justify-center align-middle ml-16 sm:ml-7 lg:ml-16 xl:ml-7">
                {hobbies.map((hobby, index) => (
                    <li key={index} className='flex items-center justify-start text-black azeret-mono-400 ml-4 xl:ml-1 text-[1.5rem] sm:text-[1.1rem] md:text-[1.2rem] lg:text-[1.7rem] xl:text-[1rem]'>
                        <span dangerouslySetInnerHTML={{ __html: hobby.emoji }} className="mr-2 opacity-100" />
