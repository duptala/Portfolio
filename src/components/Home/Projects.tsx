import ProjectsBackgroundImage from "/projects.webp";
...
const Projects = () => {
  return (
    <div className="relative w-full h-full bg-projects rounded-3xl overflow-hidden hover:shadow-purple-300/15 hover:shadow-2xl duration-150">
      ...
      />
      <div className="relative flex items-center gap-2 left-5 top-5 azeret-mono-600 font-bold text-xl sm:text-2xl">
